...
import { AttributeBooleanValue, EbsInfo, EventInformation, FpgaInfo, GpuInfo, InferenceAcceleratorInfo, InstanceStorageInfo, InstanceTypeHypervisor, MediaAcceleratorInfo, MemoryInfo, NetworkInfo, NeuronInfo, NitroEnclavesSupport, NitroTpmInfo, PermissionGroup, ProductCode, VirtualizationType } from "./models_4";
/**
 * @public
 * @enum
 */
