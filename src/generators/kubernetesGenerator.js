...
kind: Namespace
metadata:
  name: ${analysis?.projectName || 'default'}
  labels:
    generated-by: rig-cli
---
apiVersion: v1
kind: Namespace
metadata:
  name: ${analysis?.projectName || 'default'}-staging
  labels:
    generated-by: rig-cli
---
apiVersion: v1
kind: Namespace
metadata:
  name: ${analysis?.projectName || 'default'}-prod
  labels:
    generated-by: rig-cli
---`;
...
commonLabels:
  project: ${analysis?.projectName || 'my-project'}
  generated-by: rig-cli
`;
